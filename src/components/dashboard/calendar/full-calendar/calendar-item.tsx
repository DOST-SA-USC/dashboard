...
const CalendarItem = (props: {
  ...
  return (
    <div
      className={cn(
        'h-5 w-full cursor-pointer overflow-hidden rounded-sm p-1 text-[10px] font-semibold text-wrap text-white hover:opacity-80 sm:text-xs md:text-sm md:text-nowrap dark:font-medium dark:text-black',
