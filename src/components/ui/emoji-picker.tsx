...
function EmojiPicker({
  ...
  return (
    <EmojiPickerPrimitive.Root
      className={cn(
        'text-popover-foreground isolate flex h-full w-fit flex-col overflow-hidden rounded-md bg-transparent',
        className
      )}
...
function EmojiPickerCategoryHeader({
  ...
  return (
    <div
      {...props}
      className="text-muted-foreground bg-transparent px-3 pt-3.5 pb-2 text-xs leading-none"
